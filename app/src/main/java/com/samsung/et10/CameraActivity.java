...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    useFacing = intent.getIntExtra(KEY_USE_FACING, CameraCharacteristics.LENS_FACING_FRONT);
//    relativeLayout = findViewById(R.id.TF_Camera_Activity);
//  old don't use:  Rectangle newRectangle = new Rectangle(this);
//    if(relativeLayout!=null) {
//          relativeLayout.addView(new Rectangle(this, 120));
//          Toast.makeText( this,"Something returned from id TF_Camera_Activity",Toast.LENGTH_SHORT).show();
//      }
//      else {
//          Log.i(TAG, " The Null toast");
//          Toast.makeText( this,"Null returned from id TF_Camera_Activity",Toast.LENGTH_SHORT).show();
//      }
//  old don't use: cLayout.addView(newRectangle);

      buttonT = (Button) findViewById(R.id.button6);
...
*/
    ...
    /*Button proceedtotest= findViewById(R.id.button6) ;
  ...
  /*protected void starttest(){
      Intent sshow= new Intent(this, SlideShow.class);
      startActivity(sshow);
  }*/
